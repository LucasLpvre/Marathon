...
@section('content')
    <div id="serie_info">
        ...
        <p id="serie_infos">Note presse: {{$serie->note}} - Note utilisateurs: {{$note}} - {{$serie->langue}} - {{$serie->statut}}</p>
    ...
    @else
        ...
        @if($serie->id == 26)
            <iframe src="https://drive.google.com/file/d/1iAUKDckcByaTJANlAt7faBYhpfqnkpG7/preview" width="640" height="480"></iframe>
